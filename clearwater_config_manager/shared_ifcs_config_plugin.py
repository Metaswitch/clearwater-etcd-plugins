...
_log = logging.getLogger("shared_ifcs_config_plugin")
...
class SharedIFCsConfigPlugin(ConfigPluginBase):
    ...
    def on_config_changed(self, value, alarm):
        ...
        if self.status(value) != FileStatus.UP_TO_DATE:
            ...
            run_command("/usr/share/clearwater/bin/reload_shared_ifcs_config")

def load_as_plugin(params):  # pragma: no cover
    return SharedIFCsConfigPlugin(params)
